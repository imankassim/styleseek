...
export default function BasketPage() {
  ...
  if (items.length === 0) {
    return (
      <main className="mx-auto max-w-3xl px-6 py-12">
        <h1 className="mb-4 text-2xl font-semibold text-neutral-900">Basket</h1>
        <p className="text-neutral-600">Your basket is empty.</p>
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="mb-6 text-2xl font-semibold text-neutral-900">Basket</h1>
      ...
      <div className="mt-6 flex items-center justify-between border-t border-neutral-200 pt-4">
        ...
        <p className="text-lg font-medium text-neutral-900">£{totalPrice.toFixed(2)}</p>
      </div>
